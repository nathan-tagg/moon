...
void Ground :: drawMars() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, .8 /*red*/, 0.2 /*green*/, 0.2 /*blue*/);
   }
...
void Ground :: drawPluto() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, .4 /*red*/, .4 /*green*/, .7 /*blue*/);
   }
...
void Ground :: drawMercury() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 1.0 /*red*/, 0.5 /*green*/, 0.2 /*blue*/);
   }
...
void Ground :: drawVenus() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, .6 /*red*/, .5 /*green*/, .4 /*blue*/);
   }
...
void Ground :: drawUranus() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 0.5 /*red*/, .5 /*green*/, 1.5 /*blue*/);
   }
...
void Ground :: drawEverest() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, .7 /*red*/, .7 /*green*/, .7 /*blue*/);
   }
...
void Ground :: drawNeptune() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, .3 /*red*/, .5 /*green*/, 1.0 /*blue*/);
   }
...
void Ground :: drawSaturn() const
{
   ...
   pt1.addX(-PLATFORM / 2.0);
   pt2.addX( PLATFORM / 2.0);
   drawLine(pt1, pt2, 0.0 /*red*/, 1.0 /*green*/, 0 /*blue*/);
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 0.75 /*red*/, 0.50 /*green*/, 0.00 /*blue*/);
   }
...
void Ground :: drawJupiter() const
{
   ...
   pt1.addX(-PLATFORM / 2.0);
   pt2.addX( PLATFORM / 2.0);
   drawLine(pt1, pt2, 1.0 /*red*/, 0.0 /*green*/, 0.0 /*blue*/);
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 1.5 /*red*/, 0.0 /*green*/, 1.5 /*blue*/);
   }
...
void Ground :: drawSun() const
{
   ...
   pt1.addX(-PLATFORM / 2.0);
   pt2.addX( PLATFORM / 2.0);
   drawLine(pt1, pt2, 0.0 /*red*/, 0.0 /*green*/, 1.0 /*blue*/);
   ...
   for (int i = 0; i < PLATFORM; i += 5)
   {
      drawLine(pt1, pt2, 0.0 /*red*/, 0.0 /*green*/, 0.0 /*blue*/);
      pt1.addX(5);
      pt2.addX(5);
   }
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 1.5 /*red*/, 0.3 /*green*/, 0.0 /*blue*/);
   }
...
void Ground :: drawR136a1() const
{
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 0.5 /*red*/, 0.5 /*green*/, 3.0 /*blue*/);
   }
...
void Ground :: drawHole() const
{
   ...
   pt1.addX(-PLATFORM / 2.0);
   pt2.addX( PLATFORM / 2.0);
   drawLine(pt1, pt2, 0.0 /*red*/, 0.0 /*green*/, 0 /*blue*/);
   ...
   for (int i = 0; i < PLATFORM; i += 5)
   {
      drawLine(pt1, pt2, 0.0 /*red*/, 1.0 /*green*/, 0.0 /*blue*/);
      pt1.addX(5);
      pt2.addX(5);
   }
   ...
   for (int i = 0; i < xSize; i++)
   {
      Point ptBottom(topLeft.getX() + i, bottomRight.getY());
      Point ptTop   (topLeft.getX() + i, ground[i]);
      drawLine(ptBottom, ptTop, 0.0 /*red*/, 0.0 /*green*/, 0.0 /*blue*/);
   }
