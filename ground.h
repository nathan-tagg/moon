...
public:
   ...
   // display the grounds on the screen
   void drawMoon() const;
   void drawMars() const;
   void drawPluto() const;
   void drawMercury() const;
   void drawVenus() const;
   void drawUranus() const;
   void drawEverest() const;
   void drawNeptune() const;
   void drawSaturn() const;
   void drawJupiter() const;
   void drawSun() const;
   void drawR136a1() const;
   void drawHole() const;
